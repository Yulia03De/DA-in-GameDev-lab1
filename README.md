...
![image](https://user-images.githubusercontent.com/113303734/205232138-7bc5a305-bd7d-4d93-895c-b4bd3f88e32f.png)
![image](https://user-images.githubusercontent.com/113303734/205232218-b20acde9-7f72-4992-9893-64ef2ca29daa.png)
...
- График Cumulative Reward - среднее кумулятивное вознаграждение за эпизод по всем агентам. Должно увеличиться во время успешной тренировки. Общая тенденция вознаграждения должна постоянно увеличиваться с течением времени. 
...
В ходе работы интегрировала экономическую систему в проект Unity и обучила ML-Agent. Поработала с параметрами файла. yaml-агента, меняла значения для изменения обучения модели. Выяснила как некоторые параметры могут повлиять на обучение модели: learning_rate - начальная скорость обучения для градиентного спуска, она постепенно линейно уменьшается, epsilon - влияет на скорость изменения политики во время обучения, то есть происходит замедление процесса обучения.
